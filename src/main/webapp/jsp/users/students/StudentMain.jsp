...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <dl>
            ...
            <dl>
                <dt><i class="Hui-iconfont">&#xe616;</i> 学生资料<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
                        <li><a data-href="" data-title="我的信息" href="javascript:void(0)">我的信息</a></li>
                    </ul>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    <ul>
                        <li><a data-href="" data-title="查询缴费" href="javascript:void(0)">查询缴费</a></li>
                    </ul>
